...
This Code of Conduct applies within all community spaces — the repository, the
issue tracker, GitHub Discussions, and any other communication channel used by
the project. It also applies when an individual is officially representing the
...
listed in [`README.md`](README.md). All complaints will be reviewed and
